...
class AIConversationListActivity : BaseComposeActivity() {

    companion object {
        fun start(context: Context): Intent {
            val intent = Intent(context, AIConversationListActivity::class.java)
            return intent
        }
    }
    ...
    override fun RenderContent() {
        ...
        Column {
            ...
            Card(modifier = Modifier
                ...
                .padding(16.dp)
                .clickable {
                    startActivity(AIChatActivity.start(this@AIConversationListActivity))
                }) {
                Text(
                    text = "开始新的对话",
            ...
            AIConversationListScreen(modifier = Modifier.fillMaxSize())
        }
    }
